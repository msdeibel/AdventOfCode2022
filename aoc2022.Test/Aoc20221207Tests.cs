...
public class Aoc20221207Tests
{
    ...
    public void ExampleItemsDetected()
    {
        ...
        Assert.Equal(10, aoc20221207.ConsoleItems.Count(c => c.IsCommand));
        Assert.Equal(4, aoc20221207.ConsoleItems.Count(c => c.IsDir));
        Assert.Equal(10, aoc20221207.ConsoleItems.Count(c => c.IsFile));
    }

    [Fact]
    public void FirstFsItemIsRoot()
    {
        var aoc20221207 = new Aoc20221207(Example1Input());

        Assert.Equal("/", aoc20221207.FileSystemItems.First().Name);
    }

    [Fact]
    public void DirAddsDirectoryWithCurrentAsParent()
    {
        var aoc20221207 = new Aoc20221207(Example1Input());

        Assert.Equal("/", aoc20221207.FileSystemItems.First().Name);

        Assert.Equal("a", aoc20221207.FileSystemItems.First().Children.First().Name);
    }

    [Fact]
    public void FileAddsDFileWithCurrentAsParent()
    {
        var aoc20221207 = new Aoc20221207(Example1Input());

        Assert.Equal("/", aoc20221207.FileSystemItems.First().Name);

        Assert.Equal(14848514, aoc20221207.FileSystemItems.First().Children[1].Size);
        Assert.Equal(8504156, aoc20221207.FileSystemItems.First().Children[2].Size);
    }

    [Fact]
    public void CdChangesCurrentDir()
    {
        var aoc20221207 = new Aoc20221207(Example1Input());

        Assert.Equal("/", aoc20221207.FileSystemItems.First().Name);

        Assert.Equal("/", aoc20221207.CurrentFsi.Parent.Name);
        Assert.Equal("d", aoc20221207.CurrentFsi.Name);
    }
    ...
    [Fact]
    public void SumOfDirsLessEqual100_000()
    {
        var aoc20221207 = new Aoc20221207(Example1Input());
    ...
    public void Task2()
    {
        ...
        Assert.Equal(4443914, aoc20221207.GetDiretoryToDeleteSize());
    }
