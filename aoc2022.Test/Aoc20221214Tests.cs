...
public class Aoc20221214Tests
{
    private readonly ITestOutputHelper output;

    public Aoc20221214Tests(ITestOutputHelper output)
    {
        this.output = output;
    }
    ...
    public void ExampleItemsDetected()
    {
        ...
        Assert.Equal(7, aoc20221214.Coordinates.Count);
    }

    [Fact]
    public void MaxMinValuesAreCalculated()
    {
        var aoc20221214 = new Aoc20221214(Example1Input());

        Assert.Equal(494, aoc20221214.MinColIndex);
        Assert.Equal(503, aoc20221214.MaxColIndex);

        Assert.Equal(9, aoc20221214.MaxRowIndex);
    }


    [Fact]
    public void RocksAreSet()
    {
        var aoc20221214 = new Aoc20221214(Example1Input());
    ...
    [Fact]
    public void ExampleThreeGrains()
    {
        var aoc20221214 = new Aoc20221214(Example1Input());
